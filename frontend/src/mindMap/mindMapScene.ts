 ...
 * layout-run counter. NIL-606 removed the separate pin/collapse behavior;
 * stale nodeState data on an existing board has no effect on either command.
 */
...
export function arrangeOps(
  ...
  // Feeds the edge-geometry recompute below:
