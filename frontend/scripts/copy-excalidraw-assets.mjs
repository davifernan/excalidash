...
// Resolve through Node instead of assuming a package-local node_modules. npm
// workspaces may hoist Excalidraw to the repository root, while standalone
// installs may still place it below frontend/.
