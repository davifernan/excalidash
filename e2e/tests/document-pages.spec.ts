 ...
 * rather than read. 1500 keeps a real regression visible while leaving room for
 * the variation the three samples did not show.
 *
 ...
 */
const MAX_BLOCK_MS: Record<string, number> = { webkit: 1500 };
