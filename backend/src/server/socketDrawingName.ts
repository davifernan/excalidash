...
import { DRAWING_NAME_EVENT, type DrawingNameUpdate } from "@excalidash/domain/collaboration";

export { DRAWING_NAME_EVENT, type DrawingNameUpdate } from "@excalidash/domain/collaboration";
